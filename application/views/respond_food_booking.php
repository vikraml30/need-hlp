<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Food bookings Management
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addCars" action="<?php echo base_url() ?>food_bookings/send_notification" method="post" role="form" enctype="multipart/form-data">
